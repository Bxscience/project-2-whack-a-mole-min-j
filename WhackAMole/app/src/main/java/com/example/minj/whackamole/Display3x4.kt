...
const val SCORE1 = "com.example.minj.whackamole"

class Display3x4 : AppCompatActivity() {

    var num = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_display3x4)
        ...
        //grid code
        reset()
        var pos : Int = (0 .. 11).random()
        var pos2: Int = (0 .. 11).random()
        mThumbIds[pos] = R.drawable.diglet
        mThumbIds[pos2] = R.drawable.diglet
        val gridview: GridView = findViewById(R.id.gridview)
        gridview.adapter = ImageAdapter1(this)
...
class ImageAdapter1(private val mContext: Context) : BaseAdapter() {
